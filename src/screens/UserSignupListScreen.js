...
// // import React, { useState, useEffect } from 'react';
// // import { View, Text, FlatList, ActivityIndicator, StyleSheet, Alert } from 'react-native';
// // import { getUsers } from '../services/localDatabase'; // Make sure this function is correctly implemented
...
// //   const fetchUsers = async () => {
// //     try {
// //       const fetchedUsers = await getUsers(); // Fetch data from database
// //       setUsers(fetchedUsers); // Update state with fetched data
// //     } catch (error) {
// //       setError('Failed to fetch users'); // Handle error
// //       Alert.alert('Error', 'Failed to fetch users'); // Show alert on error
// //     } finally {
...
//   const renderItem = ({ item }) => (
//     <View style={styles.itemContainer}>
//       <Text style={styles.name}>{item.isSignup == 1 ? "Registerd User":item.name}</Text>
//       <Text style={styles.email}>{item.email}</Text>
//     </View>
//   );
